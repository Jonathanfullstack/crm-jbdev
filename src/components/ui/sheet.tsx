...
>(({ side = "left", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 flex h-full w-72 flex-col bg-sidebar text-sidebar-foreground shadow-soft",
        side === "left" ? "inset-y-0 left-0 border-r border-sidebar-border" : "inset-y-0 right-0 border-l",
        className,
      )}
      {...props}
    >
